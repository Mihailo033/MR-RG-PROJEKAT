...
void MainController::set_point_lights(auto shader) {
    ...
    draw_light_source_cube(glm::vec3(1.2f, 1.0f, 2.0f), 0.1f); // prvi izvor svetla
    draw_light_source_cube(glm::vec3(-1.2f, 1.0f, 2.0f), 0.1f);// drugi izvor svetla
}
...
void MainController::update_camera() {
    ...
    // Ako SHIFT pritisnut, povećaj faktor brzine
